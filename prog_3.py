...
print("Co-ordinates for window are : ")
print("Upper left corner (w1, h1) = ", w1,",", h1)
print("Bottom right corner (w2, h2) = ", w2,",", h2)
...
print("** Completed program execution ** ")
